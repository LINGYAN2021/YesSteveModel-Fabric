...
public class AuthorButton extends Button {
    ...
    public void extractContents(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (author == null || model == null || avatar == null) {
            ...
            graphics.centeredText(font, Component.literal("......"), this.getX() + this.width / 2, this.getY() + this.height / 2, ChatFormatting.GRAY.getColor());
            return;
        }
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, avatar, this.getX() + 3, this.getY() + 3, 64, 64, 0, 0, 64, 64, 64, 64);
        ...
        graphics.text(font, authorName, this.getX() + 2, this.getY() + 72, ChatFormatting.GOLD.getColor());
        graphics.centeredText(font, authorRole, this.getX() + 35, this.getY() + 82, ChatFormatting.GREEN.getColor());
