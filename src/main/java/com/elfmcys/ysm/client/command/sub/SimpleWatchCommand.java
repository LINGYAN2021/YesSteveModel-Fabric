...
public class SimpleWatchCommand {
    ...
    private static int addExpression(CommandContext<CommandSourceStack> ctx) {
        ...
        mc.execute(() -> EntityCapabilityHolder.get(mc.player, PlayerAnimatableCapabilityProvider.CAP).ifPresent(cap -> {
    ...
    private static int clearExpression(CommandContext<CommandSourceStack> ctx) {
        ...
        Minecraft mc = Minecraft.getInstance();
        mc.execute(() -> EntityCapabilityHolder.get(mc.player, PlayerAnimatableCapabilityProvider.CAP)
