...
public class ServerConfig {
    ...
    public static YsmConfigSpec.ConfigValue<String> DEFAULT_MODEL_PATH;
    public static YsmConfigSpec.ConfigValue<String> DEFAULT_MODEL_TEXTURE;

    // 禁止在玩家客户端 GUI 界面显示的模型相对路径
    public static YsmConfigSpec.ConfigValue<List<String>> CLIENT_NOT_DISPLAY_MODEL_PATHS;
    ...
    private static void init(YsmConfigSpec.Builder builder) {
